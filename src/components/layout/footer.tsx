...
export function Footer() {
  ...
  return (
    <footer className='sticky bottom-0 bg-(--footer-color)'>
      ...
      <Section>
        <Content className='flex-col justify-between gap-3 py-5 sm:flex-row sm:gap-6 sm:py-6'>
          <p className='text-center text-xs tracking-wide text-(--text-faint)'>
            &copy; 2026 &middot; {''}
            {t('footer.rights')} {''}
            &middot; {''}
            <NavLink
              href='/cookies'
              className='hover:text-foreground text-nowrap text-(--text-soft) transition-colors'
            >
              {t('footer.cookies')}
            </NavLink>
          </p>
              ...
              return (
                <button
                  ...
                  className={`text-xs tracking-wide transition-colors disabled:opacity-50 ${
                    isActive
                      ? 'text-foreground'
                      : 'hover:text-foreground text-(--text-faint)'
                  }`}
                >
                  {info.name}
                </button>
