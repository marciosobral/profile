...
export default function CookiePolicy() {
  ...
  return (
    <section className='flex min-h-[80vh] flex-col justify-center px-6 py-16 sm:px-12 lg:px-24'>
      <div className='max-w-3xl'>
        ...
        <p className='mb-12 max-w-xl text-base leading-relaxed text-(--text-soft) sm:text-lg'>
          {t('intro')}
        </p>
